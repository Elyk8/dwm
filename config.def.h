...
static const char *colors[][3] = {
  ...
  [SchemeTagsSel]  = { normfgcolor, normbgcolor, "#000000" },  // Tagbar left selected {text,background,not used but cannot be empty}
  [SchemeInfoNorm] = { normfgcolor, normbgcolor, "#000000" },  // infobar middle  selected {text,background,not used but cannot be empty}
  [SchemeInfoSel]  = { "#23D18B",  normbgcolor,  "#000000"  },  // infobar middle  unselected {text,background,not used but cannot be empty}
...
const char *spcmd3[] = {TERMINAL, "-n", "spmusic", "-g", "100x25", "-e", "ncmpcpp", " ", NULL};
...
/* const char *spcmd3[] = {TERMINAL, "--class", "spmusic", "-o", "window.dimensions.columns=100", "window.dimensions.lines=34", "-e", "ncmpcpp"," ", NULL }; */
...
static Key keys[] = {
    ...
    /* { MODKEY|ShiftMask,             XK_b,                   incnmaster,             {.i = +1 } }, */
    { MODKEY,                       XK_n,                   spawn,                  SHCMD(TERMINAL " -e newsboat; pkill -RTMIN+6 dwmblocks") },
    { MODKEY|ShiftMask,             XK_n,                   spawn,                  SHCMD("rofinotes") },
